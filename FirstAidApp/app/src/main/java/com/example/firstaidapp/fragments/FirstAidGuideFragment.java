...
public class FirstAidGuideFragment extends Fragment implements EmergencyConditionAdapter.OnItemClickListener {
    ...
    private List<EmergencyCondition> getAllEmergencyConditions() {
        ...
        conditions.add(new EmergencyCondition(8, "Luka Sayat", "Penanganan luka sayat dan mencegah infeksi", R.drawable.cut));
        conditions.add(new EmergencyCondition(9, "Cedera Kepala", "Penanganan cedera kepala dan gegar otak", R.drawable.headinjury));

        // Medical conditions
        conditions.add(new EmergencyCondition(10, "Serangan Jantung", "Penanganan gejala serangan jantung", R.drawable.heartattack));
        conditions.add(new EmergencyCondition(11, "Stroke", "Pengenalan gejala stroke dan penanganan awal", R.drawable.stroke));
